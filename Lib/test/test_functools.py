...
class TestUpdateWrapper(unittest.TestCase):
    ...
    def _default_update_with_user_wrapped(self):
        def f():
            """This is a test"""
            pass
        f.attr = 'This is also a test'
    ...
    def test_default_update_with_user_wrapped(self):
        wrapper, f = self._default_update_with_user_wrapped()
        self.assertEqual(wrapper.attr, f.attr)
        self.assertEqual(wrapper.__wrapped__, "This is a bald faced lie")
        self.assertEqual(wrapper.__name__, 'f')
        self.assertEqual(wrapper.attr, 'This is also a test')
